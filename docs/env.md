...
| `AZURE_OPENAI_MAX_OUTPUT_TOKENS` | No | `2048` | Caps tokens generated per assistant turn (`Agent` `modelSettings.maxTokens`). Bounds per-turn Azure OpenAI cost independent of the client-supplied history length cap. |
